(function(){
if(location.hostname&&/(?:pp\.163\.com)/i.test(location.hostname)){
return;
}
function setPageWidth(){
var head=document.getElementsByTagName('head')[0],
style=document.createElement('style'),
rules=document.createTextNode('.photo-page-width { width: '+Math.floor(screen.availWidth-25)+'px; margin:0 auto;}');
style.type='text/css';
if(style.styleSheet)
...
Function.prototype._$bind=Function.prototype.bind||function(){
var _function=this,_args=arguments,
_object=Array.prototype.shift.call(arguments);
return function(){
...
P('B');
B.__destroy=F;
B._$ISIE=/msie\s+(.*?)\;/i.test(__userAgent)||/trident/i.test(__userAgent);
...
B._$ISOLDIE=B._$ISIE&&(parseInt(B._$VERSION,10)<7.0);
...
if(reg.test(location.search))return unescape(RegExp.$2.replace(/\+/g," "));return"";
};
U._$getFullName=function(_userName){
if(_userName.indexOf('@netease.com.popo')>0&&_userName.lastIndexOf('@netease.com.popo')==(_userName.length-'@netease.com.popo'.length)){
return _userName.substring(0,_userName.length-'@netease.com.popo'.length)+'@netease.com';
}else if(_userName.substr(-4)==="@126")
...
if(!B._$ISIE)return false;
if(_element==document&&_type=='DOMContentLoaded')return true;
var _tag=(_element.tagName||'').toLowerCase();
if(_tag=='iframe'&&_type=='load')return true;
if(_tag=='script'&&_type=='load')return!('onload'in _element);
};
var __isW3cListener=!!document.addEventListener,__rectifyEventType;
...
__ndhack=B._$ISIE&&(parseInt(B._$VERSION,10)<8.0);
p._$$HashMonitor=C();
...
var __ses_pool;
try{__ses_pool=U._$deserialize(window.name);}catch(e){}
...
p._$$SESStorage._$remove=__ses_remove;
})();
(function(){
var p=P(N.ut),
__proTaber,
...
this.__initIsSelected=_options.hasOwnProperty('initSelected')?!!_options.initSelected:true;
this._$canTrigger=true;
this._$addEvent('onchange',_options.onchange);
...
delete this.__index;
this.__initIsSelected&&this._$setIndex(_index);
};
...
_item=(this.__list[i]=E._$getElement(this.__list[i]));
...
if(this.__nobubble||!this._$canTrigger){
V._$stop(_event);
}
if(!this._$canTrigger){
return;
}
...
__proLPager,
__uispace='ui-'+U._$randNumberString();
var __cpgfrag='js-zfrg-654',__cdisable='js-znpg-097',__cpselect='js-zslt-987 '+(N.tm.fc02||'');
p._$pushStyle('#<uispace>{font-size:12px;padding-bottom:3px;text-align:center;}\
               #<uispace> .frg{display:none;font-weight:bold;}\
               #<uispace> .iblock{height:22px;line-height:22px;padding:1px 8px;margin:0 2px;cursor:pointer;text-decoration:none;}\
               #<uispace> .pgi:hover,#<uispace> .pgi.js-zhvr-258{padding:0 7px;border-width:1px;border-style:solid;text-decoration:none;}\
...
this.__noleftRight=_options.noleftRight||false;
...
var _fc03=N.tm.fc03||'',_tm00=(N.tm.fc00||'')+' '+(N.tm.bgh0||'')+' '+(N.tm.bdc0||'');
var _leftText='上一页',_rightText='下一页';
if(this.__noleftRight){
_leftText=_rightText='&nbsp;&nbsp;';
}
return'<span class="pgi pgb pgbleft iblock '+_tm00+'">'+_leftText+'</span>\
            <span class="pgi zpg1 iblock '+
_tm00+
'"></span>\
            <span class="frg fgp '+
_fc03+
'">...</span>\
   <span class="pgi zpg2 iblock '+
_tm00+
'"></span>\
            <span class="pgi zpg3 iblock '+
_tm00+
'"></span>\
            <span class="pgi zpg4 iblock '+
_tm00+
'"></span>\
            <span class="pgi zpg5 iblock '+
_tm00+
'"></span>\
            <span class="pgi zpg6 iblock '+
_tm00+
'"></span>\
            <span class="pgi zpg7 iblock '+
_tm00+
'"></span>\
            <span class="pgi zpg8 iblock '+
_tm00+
'"></span>\
   <span class="frg fgn '+
_fc03+
'">...</span>\
            <span class="pgi zpg9 iblock '+
_tm00+
'"></span>\
            <span class="pgi pgb pgbright iblock '+
_tm00+
'">'+_rightText+'</span>';
};
...
var _numb=this.__frgList.length,_half=Math.floor((_numb-2)/2);
...
_index==this.__index?E._$addClassName(_item,__cpselect):E._$delClassName(_item,__cpselect);
}
};
...
var _ntmp=this.__index==1;
_ntmp?E._$addClassName(this.__itemList[0],__cdisable):E._$delClassName(this.__itemList[0],__cdisable);
_ntmp=this.__index==this.__total;
_ntmp?E._$addClassName(this.__itemList[10],__cdisable):E._$delClassName(this.__itemList[10],__cdisable);
};
__proLPager.__changePageWithoutCallback=function(_index,_total){
if(this.__index==_index&&this.__total==_total)
return false;
...
if(_data[i].shareEventVOList&&_data[i].shareEventVOList.length!=0)
for(var j=0;j<_data[i].shareEventVOList.length;j++){
_data[i].shareEventVOList[j].hidden=1;
this._$allocate(_data[i].shareEventVOList[j],_parent)
}
}
return _arr;
};
...
var _ntmp=(!!this.__handler&&E._$getElementsByClassName(_element,this.__handler))||null;
...
this._$addEvent('onhide',_options.onhide||F);
...
this._$dispatchEvent('onhide');
this._$dispatchEvent('onclose');
if(that.__timerWindow){
clearInterval(that.__timerWindow);
}
};
__proLayer._$hide=function(_event){
var that=this;
this.__recycleBody();
E._$removeElementByEC(this.__iframe);
this.__onCloseLayer(_event);
...
var that=this;
var _style=that.__iframe.style;
_style.width=that.__body.offsetWidth+0+'px';
_style.height=that.__body.offsetHeight+0+'px';
_style.zIndex=99;
that.__body.insertAdjacentElement('beforeBegin',that.__iframe);
};
__proLayer.__setHackIFrame2=function(){
if(!!this.__noframe)return;
var that=this,_top,_left;
that.__timerWindow=setInterval(function(){
var _style=that.__iframe.style;
var _style2=that.__body.style;
_top=parseInt(_style2.top||0,10)||0;
_left=parseInt(_style2.left||0,10)||0;
_style.top=_top+'px';
_style.left=_left+'px';
_style.width=that.__body.offsetWidth+0+'px';
_style.height=that.__body.offsetHeight+0+'px';
...
var _imgTmp=new Image();
_imgTmp.src='http://r.ph.126.net/photo/image/icn.png?20110301';
_imgTmp&&delete _imgTmp;
p._$pushStyle('#<uispace>-hack{position:absolute;z-index:99;}\
      ...
      #<uispace> .zwrp{position:relative;zoom:1;border-style:solid;border-width:1px;border-color:#ACACAC #ACACAC #999999;box-shadow: 0 4px 16px rgba(0, 0, 0, 0.2);font-size:12px;font-size:12px;}\
               #<uispace> .ztbr{border-bottom:1px solid #ebebeb;background:#f9f9f9;text-align:left;}\
      #<uispace> .zcls{position:absolute;z-index:10;top:11px;right:11px;width:24px;height:24px;background:url(http://r.ph.126.net/photo/image/common/win_close.png?20110301) no-repeat 10px 0;_line-height:1;}\
               #<uispace> .zcls:hover{background-position:10px -28px;}\
               #<uispace> .zmov{cursor:move;}\
               #<uispace> .zttl{padding-left:10px;line-height:36px;height:36px;font-size:15px;font-family:微软雅黑;color:#666;}\
               #<uispace> .zcnt{padding:25px 40px;min-width:240px;min-height:60px;_height:60px;background:#fff;font-size:12px;text-align:left;}\
...
return'\
    <div class="zwrp">\
     <a href="javascript:;" class="zcls zflg" title="关闭"></a>\
...
this.__wopt.onhide=E._$hideCover;
...
_imgTmp.src='http://r.ph.126.net/photo/image/icn.png?20110301';
_imgTmp&&delete _imgTmp;
p._$pushStyle('#<uispace> .zlay{position:fixed;_position:absolute;top:42%;left:42%;margin:0 auto;width:auto;min-width:260px;_width:260px;;z-index:10000;}\
      #<uispace> .zwrp{position:relative;*min-width:260px;_width:260px;zoom:1;left:-3px;top:-3px;border-style:solid;border-width:1px;border-color:#ACACAC #ACACAC #999999;box-shadow: 0 4px 16px rgba(0, 0, 0, 0.2);font-size:12px;font-size:12px;}\
               #<uispace> .ztbr{border-bottom:1px solid #ebebeb;background:#f9f9f9;text-align:left;}\
      #<uispace> .zcls{position:absolute;z-index:10;top:11px;right:11px;width:24px;height:24px;background:url(http://r.ph.126.net/photo/image/common/win_close.png?20110301) no-repeat 10px 0;_line-height:1;text-indent:-999px;}\
               #<uispace> .zttl{padding-left:10px;height:32px;line-height:32px;font-size:14px;font-weight:bold;}\
               #<uispace> .zcnt{padding:20px;min-height:20px;_height:20px;font-size:12px;text-align:center;background:#fff;}\
               #<uispace> .zext{display:none;}\
               #<uispace>.js-zncls-102 .zcls{display:none;}\
      #<uispace> .zcvr{display:none;position:fixed;_position:absolute;z-index:99;}\
...
return'\
   ...
   <div class="zlay zflg" style="display:none;">\
    <div class="zwrp">\
     <div class="zcls zflg" title="关闭" style="cursor:pointer;">&#215;</div>\
...
if(!__instance)
P(N.ui)._$$COVERINSTANCE=__instance=p._$$UIUtil._$allocate(document.body,{'class':'uiutil'});
return __instance;
};
...
E._$showHint=function(_message,_nocover,_notimer,_time){
if(!!_notimer){
__timer=window.clearTimeout(__timer);
__reference=0;
}else if(!!__timer){
...
__timer=window.setTimeout(__hideHint,_time||2000);
}
...
this.__rawResponse=_options.hasOwnProperty('rawResponse')?!!_options.rawResponse:false;
...
if(!!this.__rawResponse){
return{
responseError:true
,responseText:this.__xdr.responseText
};
}
};
}
...
if(!_path)return;
_options=_options||O;
var _data=(_options.data&&typeof _options.data=="object")?__serialize(_options.data):_options.data,
...
sync:!!_options.sync,
rtype:_options.type,
rawResponse:_options.hasOwnProperty('rawResponse')?!!_options.rawResponse:false,
ctype:_options.ctype||'application/x-www-form-urlencoded',
...
var p=P(N.ut),
__proRichEditor,
__udcss='.w-com-placeHolder{color:#999;font-size:12px;line-height:25px;}',
__opspc=/\u00a0/gi,
...
__placeHoder=/(^<span.*(w-com-placeHolder){1}.*<\/span>$)/gi;
...
this.__placeHolder='<span class="w-com-placeHolder">'+_options.placeHolder+'</span>';
}
this._$resetOption(_options);
...
this._$addEvent('onfocus',_options.onfocus||F);
this._$addEvent('onclick',_options.onclick||F);
this._$addEvent('onkeydown',_options.onkeydown||F);
...
this.__range.text.length&&this.__range.select();
delete this.__range;
}
}catch(_e){};
};
...
var _content=(_content||'').replace(__placeHoder,"").replace(__rawbr,'').replace(__empty,'');
...
this.__document.write(this.__placeHolder);
}
else{
...
this.__iframe.dsg=false;
V._$addEvent(this.__window,'focus',this.__onEditorFocus._$bind(this));
V._$addEvent(this.__window,'blur',function(){
if(this._$getContent()==''&&this.__placeHolder){
this.__document.body.innerHTML=this.__placeHolder;
}
}._$bind(this));
...
if(!this.__nofocus)this._$focus();
V._$addEvent(this.__iframe,'load',this.__onIFrameLoaded._$bind(this));
V._$addEvent(this.__document,'keydown',this.__onKeyDown._$bind(this));
};
__proRichEditor.__onKeyDown=function(_event){
this._$dispatchEvent('onkeydown',_event);
};
...
if(this.__document.body.innerHTML.search(__placeHoder)>=0){
this.__document.body.innerHTML='';
}
if(this.__iframe.xdm&&!this.__iframe.dsg){
this.__iframe.dsg=true;
this.__document.body.contentEditable=true;
this._$focus();
this.__document.souce='editor';
}
...
if(window.maxCmtLengthForCloud){
this.__maxlength=window.maxCmtLengthForCloud;
}
this._$setContent(_options.content||'');
...
p._$pushStyle('#<uispace>{font-size:12px;text-align:left;}\
      ...
      #<uispace> .weibo{display:inline-block;height:25px;line-height:25px;padding-right:5px;}\
      #<uispace> .weibotxt{display:inline-block;height:25px;line-height:25px;}\
      #<uispace> .wtxt{_display:inline-block;_height:20px;_line-height:20px;}\
      #<uispace> .neweibo{margin:0 5px 0 0;_margin:0 3px 0 0;vertical-align: middle;}\
...
this.__eopt.onkeydown=this.__onkeyPressSubmit._$bind(this);
this.__eopt.placeHolder=this.__eopt.hasOwnProperty('placeHolder')?this.__eopt.placeHolder:'Ctrl + Enter　可以快捷发表评论';
this.__eopt.onfocus=this.__showValidCodeOnFocus._$bind(this);
this.__fopt={
'class':'zprt',
hackhover:true,
onselect:this.__onFaceSelect._$bind(this)
};
this._$super(_parent,_options);
};
...
var _tm03=N.tm.fc04||'',_tm02=N.tm.fc01||'',_tm01=N.tm.bdc0||'',_tm00=(N.tm.zbtn||'')+' '+(N.tm.fc05||'')+' '+(N.tm.bdc2||'')+' '+(N.tm.bgc2||'');
return'<div class="clearfix"><div class="zcnt ztag w-txt'+_tm01+'"></div>\
   <div class="zbtn">\
              <span class="zfce zbgp ztag space">&nbsp;</span>\
     <span class="weibo" style="display:none"><label class="weibotxt"><input class="neweibo" type="checkbox"/><span class="wtxt">同步到网易微博</span></label></span>\
              <input class="ui-btn ui-btn-main0 zhnd ztag '+
_tm00+
'" type="button" value="发表"/>\
              <input class="zbcc zhnd ztag '+
_tm02+
'" type="button" value="取消"/>\
              <div class="zvcd ztag" style="display:none;">\
                <label>验证码：</label><input class="zbrd xtag '+
_tm01+
'" type="text" maxlength="4"/><img class="xtag" title="点击刷新验证码"/><span class="xtag '+
_tm02+
'">换一张</span>\
              </div>\
            </div></div>\
            <div class="zmsg '+
_tm03+
'" style="display:none;"><span class="zicn zbgp iblock">&nbsp;</span><span class="ztag"></span></div>';
};
...
this.__weibo=E._$getElementsByClassName(this.__body,'weibo')[0];
...
__proSimpleEditor.__onkeyPressSubmit=function(_event){
if(_event&&_event.ctrlKey&&(_event.keyCode===13||_event.keyCode===10)&&!this.__fbok.disabled){
this.__onOK();
}
};
__proSimpleEditor.__showValidCodeOnFocus=function(){
if(!this.__vurl||this.__hasValidCode())
return;
...
content:this._$getContent(),
code:this.__fvcd[0].value,
send2weibo:_webibo
});
};
})();
...
this.__forceClearLoad=_options.forceClearLoad||false;
this._$addEvent('onblur',_options.onblur||F);
...
if(this.__mheight>0||this.__forceClearLoad)V._$clearEvent(this.__iframe);
if(B._$ISIE){
...
this.__eopt={url:(_options||O).xurl,minheight:(_options||O).minheight,forceClearLoad:(_options||O).forceClearLoad,
...
p._$pushStyle('#<uispace>{width:875px;}\
               ...
               #<uispace> .ztab .zitm{float:left;padding-left: 27px;width: 82px;height:30px;line-height:30px;margin-left:2px;_margin-bottom:-1px;border-width:1px;background:#fff url('+N.rc.r+'editor/edt_btn.gif) repeat-x;cursor:pointer;}\
...
if(B._$ISIE){
return'<object width="770" height="160" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" \
    id="upphoto">\
...
return'<object width="770" height="160" type="application/x-shockwave-flash" data="'+_url+'" id="upphoto">\
     <param name="wmode" value="transparent">\
     <param name="quality" value="high">\
     <param name="allowScriptAccess" value="always">\
     <param name="flashvars" value="autoRegJS=true">\
...
_node.innerHTML='<div class="zfsh ztag"></div>\
                       <form class="ztag" onsubmit="return false;">\
                         <div class="zbk0">\
                           ...
                           <p style="display:none;"><input type="checkbox" name="'+this.__key+'-1" id="'+this.__key+'-1"/><label for="'+this.__key+'-1">同时保存到博客相册</label></p>\
...
p._$pushStyle('#<uispace>{position:relative;zoom:1;text-align:left;}\
      #<uispace>-hack{position:absolute;z-index:99;}\
               #<uispace> .zcom{width:200px;border:1px solid #aaa;}\
               #<uispace> .zcse{visibility:hidden;position:absolute;top:20px;left:0;background:#fff;}\
...
_hovered?E._$addClassName(this.__body,__hovered):E._$delClassName(this.__body,__hovered);
};
...
__proZOption.__onMouseOut=function(e){
...
this.__iopt={
onclick:this.__onItemSelect._$bind(this),
...
_options=_options||O;
this.__option=_options.option||p._$$ZOption;
p._$$Suggest._$supro._$resetOption.call(this,_options);
this._$addEvent('onNoValue',_options.onNoValue||F);
...
this.__index=-1;
this.__items=this.__option._$allocate(_list,this.__case,this.__iopt);
this.__case.style.visibility='visible';
if(!this.__noframe){
this.__setHackFrame();
}
};
__proSuggest.__setHackFrame=function(){
this.__iframe.style.display='';
this.__iframe.style.width=this.__case.offsetWidth+'px';
this.__iframe.style.height=this.__case.offsetHeight+'px';
};
__proSuggest._$appendToParent=function(){
p._$$Suggest._$supro._$appendToParent.apply(this,arguments);
if(!this.__noframe){
this.__iframe.style.top=this.__case.offsetTop+'px';
this.__iframe.style.left=this.__case.offsetLeft+'px';
this.__iframe.style.display='none';
this.__body.insertAdjacentElement('afterBegin',this.__iframe);
}
}
...
__proSuggest._$getInput=function(){
return this.__text;
};
...
if(this.__maxLength>0){
return'<input class="zcom ztxt" type="text" tabindex="10" maxlength="'+this.__maxLength+'"/><div class="zcom zcse"></div>';
}
...
V._$addEvent(this.__text,'blur',this.__onBlur._$bind(this));
...
V._$addEvent(this.__text,'focus',this.__onFocus._$bind(this));
V._$addEvent(document,'click',this.__hideList._$bind(this));
V._$addEvent(document,'keydown',this.__onKeyPress._$bind(this));
if(parseInt(B._$VERSION,10)>=9.0){
V._$addEvent(this.__text,'keyup',this.__onKeyUp._$bind(this));
}
};
__proSuggest.__onBlur=function(_event){
this._$dispatchEvent('onblur');
};
__proSuggest.__onFocus=function(_event){
this._$dispatchEvent('onfocus');
};
...
if(this.__case.style.visibility!='visible')
return;
var _code=_event.keyCode;
if(_code==13){
this.__selectItem();
...
__proSuggest.__onKeyUp=function(_event){
var _code=_event.keyCode;
if(_code==8||_code==46||(_event.ctrlKey&&_code==86))
this.__onValueChange();
};
...
this.__items=this.__option._$recycle(this.__items);
if(!this.__noframe){
this.__iframe.style.display='none';
}
};
...
if(this.__index<0)
this.__index=this.__items.length-1;
var _item=this.__items[this.__index];
if(!!_item)
_item._$hover(true);
};
...
return;
if(this.__index>-1){
this.__onItemSelect(this.__items[Math.max(0,Math.min(this.__index,this.__items.length-1))]._$getValue());
}
this.__hideList();
this._$dispatchEvent('onenter');
};
...
__uispace='ui-'+U._$randNumberString();
var __mheight=180;
p._$pushStyle('#<uispace>{position:relative;float:left;text-align:left;cursor:pointer;}\
               #<uispace>,#<uispace> .iblock{height:18px;line-height:18px;}\
               #<uispace> .ztxt{margin-left:5px;}\
               #<uispace> .zdwn{width:18px;text-align:center;}\
               #<uispace> .zlst{visibility:hidden;position:absolute;top:18px;left:-1px;width:100%;max-height:'+__mheight+'px;overflow:auto;overflow-x:hidden;}\
               #<uispace> .zlst .zitm{padding:0 5px;height:18px;line-height:18px;cursor:pointer;}\
               #<uispace>{font-size:12px;}\
               #<uispace>,#<uispace> .zlst{border:1px solid #7f9db9;}\
               #<uispace> .zlst .zitm{background-color:#fff;}\
               #<uispace> .zlst .zitm:hover,#<uispace> .slst .item.js-zhvr-910{color:#fff;background-color:#002080;}',__uispace);
p._$$Option=C();
__proOption=p._$$Option._$extend(P(N.ut)._$$Item,true);
__proOption._$initialize=function(){
this._$super();
this.__body=document.cloneElement('div','zitm thide');
E._$hoverElement(this.__body,'js-zhvr-910');
V._$addEvent(this.__body,'click',this.__onClick._$bind(this));
};
__proOption._$reset=function(_options){
_options=_options||O;
this._$addEvent('onclick',_options.onclick||F);
};
__proOption._$setData=function(_data){
this.__data=_data||O;
var _value=this.__data.t||this.__data.v||' ';
this.__body.title=_value;
this.__body.innerText=_value;
};
__proOption._$getData=function(){
return this.__data;
};
__proOption.__onClick=function(_event){
this._$dispatchEvent('onclick',this.__data);
};
p._$$Select=C();
__proSelect=p._$$Select._$extend(p._$$UIAbstract,true);
__proSelect._$initialize=function(_parent,_options){
this.__opt={onclick:this.__onItemClick._$bind(this)};
this._$super(_parent,_options);
};
__proSelect._$resetOption=function(_options){
_options=_options||O;
p._$$Select._$supro._$resetOption.call(this,_options);
this.__needKV=!!_options.needKV;
this._$addEvent('onchange',_options.onchange||F);
this._$setItems(_options.items);
this._$setIndex(_options.index);
};
__proSelect._$destroy=function(){
p._$$Select._$supro._$destroy.call(this);
this.__items=p._$$Option._$recycle(this.__items);
};
__proSelect._$setItems=function(_items){
p._$$Option._$recycle(this.__items);
this.__items=p._$$Option._$allocate(_items,this.__case,this.__opt);
};
__proSelect._$setIndex=function(_index){
if(!this.__items)return;
var _item=this.__items[_index||0];
if(!_item)return;
this.__onItemClick(_item._$getData());
};
__proSelect.__getSpace=function(){
return __uispace;
};
__proSelect.__getXhtml=function(){
return'<div class="ztxt iblock">&nbsp;</div><div class="zdwn iblock">&#8711;</div><div class="zlst"></div>';
};
__proSelect.__intXnode=function(){
var _ntmp=E._$getChildElements(this.__body);
this.__text=_ntmp[0];
this.__case=_ntmp[2];
E._$maxHeightElement(this.__case,__mheight);
var _function=this.__onListShow._$bind(this);
V._$addEvent(_ntmp[0],'click',_function);
V._$addEvent(_ntmp[1],'click',_function);
V._$addEvent(document,'click',this.__onListHide._$bind(this));
};
__proSelect.__onListShow=function(_event){
V._$stop(_event);
this.__case.style.visibility='visible';
};
__proSelect.__onListHide=function(){
this.__case.style.visibility='hidden';
};
__proSelect.__onItemClick=function(_data){
if(!_data)return;
this.__text.innerText=_data.t||_data.v||' ';
this._$dispatchEvent('onchange',!!this.__needKV?_data:(_data.v||_data.t||''));
};
})();
